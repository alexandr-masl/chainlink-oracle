...
const { highLevelOracleAddress, REQUEST_COIN_PRICE_JOB, REQUEST_CROSS_CHAIN_COIN_PRICE_JOB} = require('../../settings.json')
...
describe("Token Balance Check", function () {
    ...
    it("should call requestEthereumPrice of HighLevelOracleBalance", async function () {
        ...
        const txSetJobIDToRequestType = await highLevelOracle.setJobIDToRequestType(REQUEST_CROSS_CHAIN_COIN_PRICE_JOB, 2, { gasPrice, gasLimit });
