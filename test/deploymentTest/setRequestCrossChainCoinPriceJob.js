...
const { oracleAddress, REQUEST_CROSS_CHAIN_COIN_PRICE_JOB} = require('../../settings.json')
...
describe("Token Balance Check", function () {
    ...
    it("should call requestEthereumPrice of HighLevelOracleBalance", async function () {
        ...
        const txSetJobIDToRequestType = await oracle.setJobIDToRequestType(REQUEST_CROSS_CHAIN_COIN_PRICE_JOB, 2, { gasPrice, gasLimit });
